...
def add_eeg_column(file_path, output_path):
    ...
    n = 8  # Number of bits of the channel (assumed)
...
output_path = '/Users/omarg/Desktop/SYP-GambitGameDev/Data_Analysis/DataCH4/27_11_2023__16_43_15_new_voltage.csv'  # Replace with the desired path for the output CSV file
